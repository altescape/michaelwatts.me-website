...
And this is what NVDA will read out aloud:
...
considering the semantics of your HTML structure, but also considering when it does look correct that the screen reader might not interpret it as such.
