...
<ul class="list-none bg-stripes-slate rounded-lg m-0 p-5 flex gap-3">
  <li class="list-none w-80 bg-slate-100 dark:bg-slate-800 rounded-lg overflow-hidden shadow-2xl border mb-0">
    <a href="https://example.com">
      <img
...
<ul class="list-none bg-stripes-slate rounded-lg m-0 p-5 flex gap-3">
  <li class="flex flex-col list-none w-80 bg-slate-100 dark:bg-slate-800 rounded-lg overflow-hidden shadow-2xl border relative mb-0">
